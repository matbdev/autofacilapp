...
public final class PainelGerenciamentoAlugueis extends JPanel {
    ...
    // ALTERADO: de JDateChooser para DatePicker
    ...
    private JPanel createPainelSaida() {
        ...
        // NOVO: DatePicker para Data de Saída
        gbc.gridy++;
        gbc.gridx = 0;
        gbc.weightx = 0;
        ...
        settingsSaida.setDateRangeLimits(LocalDate.now(), null); // Não pode ser antes de hoje
        pickerDataSaida = new DatePicker(settingsSaida);
        pickerDataSaida.setDateToToday();
        painel.add(pickerDataSaida, gbc);

        // NOVO: DatePicker para Previsão de Devolução
        gbc.gridy++;
        gbc.gridx = 0;
        gbc.weightx = 0;
        ...
        // A data mínima da devolução é o dia seguinte à saída
    ...
    private JPanel createPainelDevolucao() {
        ...
        // NOVO: DatePicker para Devolução Efetiva
        gbc.gridy++;
        gbc.gridwidth = 1;
        gbc.gridx = 0;
        gbc.weightx = 0;
    ...
    private void setupListeners() {
        ...
        // NOVO: Atualiza a data mínima da devolução quando a data de saída muda
        pickerDataSaida.addDateChangeListener(e -> {
            ...
            if (dataSaida != null) {
                ...
                // Se a data prevista for anterior à nova data mínima, ajusta-a
